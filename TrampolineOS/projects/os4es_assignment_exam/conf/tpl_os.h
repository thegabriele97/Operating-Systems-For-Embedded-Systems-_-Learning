...
DeclareTask(TaskDisplayManager);
DeclareTask(TaskSender);
DeclareTask(TaskTwitterer);
DeclareAlarm(ALARMBitTiming);
DeclareAlarm(ALARMMsgPause);
DeclareAlarm(ALARMStopDisplay);
DeclareEvent(EVTBitTiming);
DeclareEvent(EVTMsgPause);
DeclareEvent(EVTMsgSendCompleted);
