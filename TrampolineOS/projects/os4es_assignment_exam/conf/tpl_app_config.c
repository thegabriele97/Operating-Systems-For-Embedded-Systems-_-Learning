 ...
 * Automatically generated by goil on Thu Nov 12 22:07:48 2020
 ...
 */
/*-----------------------------------------------------------------------------
 * Counter EnhancedCounter descriptor
 */

#define API_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

CONST(tpl_tick, OS_CONST) OSTICKSPERBASE_EnhancedCounter = 1;
CONST(tpl_tick, OS_CONST) OSMAXALLOWEDVALUE_EnhancedCounter = 16777215;
CONST(tpl_tick, OS_CONST) OSMINCYCLE_EnhancedCounter = 1;
...
VAR(tpl_counter, OS_VAR) EnhancedCounter_counter_desc = {
  /* ticks per base       */  1,
...
{
  tpl_avr_counter_tick(&EnhancedCounter_counter_desc);
}
...
#include "tpl_memmap.h"
tpl_stack_word TaskTwitterer_stack_zone[128/sizeof(tpl_stack_word)];
...
#define TaskTwitterer_STACK { TaskTwitterer_stack_zone, 128 }
 ...
 *
 * This alarm does a set of event EVTBitTiming to task TaskTwitterer
 */
