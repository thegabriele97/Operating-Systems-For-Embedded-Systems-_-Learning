 ...
 */
/*-----------------------------------------------------------------------------
 * Constants of the counter GoodCounter
 */
extern CONST(tpl_tick, OS_CONST) OSTICKSPERBASE_GoodCounter;
extern CONST(tpl_tick, OS_CONST) OSMAXALLOWEDVALUE_GoodCounter;
extern CONST(tpl_tick, OS_CONST) OSMINCYCLE_GoodCounter;
