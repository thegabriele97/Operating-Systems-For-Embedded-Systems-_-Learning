 ...
 */
/*-----------------------------------------------------------------------------
 * Constants of the counter EnhancedCounter
 */
extern CONST(tpl_tick, OS_CONST) OSTICKSPERBASE_EnhancedCounter;
extern CONST(tpl_tick, OS_CONST) OSMAXALLOWEDVALUE_EnhancedCounter;
extern CONST(tpl_tick, OS_CONST) OSMINCYCLE_EnhancedCounter;
