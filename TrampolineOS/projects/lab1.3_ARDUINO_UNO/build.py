...
cSourceList.append(projfile.ProjectFile("hooks.cpp"))
cSourceList.append(projfile.ProjectFile("code.cpp"))
cSourceList.append(projfile.ProjectFile("task.cpp"))
cSourceList.append(projfile.ProjectFile("MyArduino.cpp"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab1.3.hex from lab1.3")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab1.3")
  postCommand.mCommand.append("lab1.3.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab1.3 on avr/arduino/uno\033[0m")
