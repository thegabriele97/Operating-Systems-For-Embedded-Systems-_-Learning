...
#--- automatically generated by goil on Tue Nov  3 12:01:03 2020
...
cSourceList.append(projfile.ProjectFile("task.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary myProject.hex from myProject")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing myProject on avr/arduino/uno\033[0m")
