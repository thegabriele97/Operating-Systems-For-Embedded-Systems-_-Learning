...
/* Event EVT */
#define EVT_mask 1
CONST(EventMaskType, AUTOMATIC) EVT = EVT_mask;
 ...
 *
 * This alarm does a callback of function suca_callback
 */
...
FUNC(void, OS_APPL_CODE) suca_callback(void);
...
CONST(tpl_callback_action, OS_CONST) Alarm1_action = {
  {
    /* action function  */    tpl_action_callback
  },
  /* callback function    */  suca_callback
};
