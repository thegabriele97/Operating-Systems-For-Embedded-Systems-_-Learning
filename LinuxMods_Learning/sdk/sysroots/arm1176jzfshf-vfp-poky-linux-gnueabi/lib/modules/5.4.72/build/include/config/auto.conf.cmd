...
ifneq "$(KERNELVERSION)" "5.4.72"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-poky-linux-gnueabi-gcc (GCC) 9.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-poky-linux-gnueabi-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-poky-linux-gnueabi-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
