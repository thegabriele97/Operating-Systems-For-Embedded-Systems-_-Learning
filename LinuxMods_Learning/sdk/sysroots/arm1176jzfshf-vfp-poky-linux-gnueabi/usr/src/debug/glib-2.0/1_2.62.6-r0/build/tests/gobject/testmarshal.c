...
/* BOOLEAN:INT (../glib-2.62.6/tests/gobject/testmarshal.list:2) */
void
...
/* STRING:INT (../glib-2.62.6/tests/gobject/testmarshal.list:3) */
void
...
/* VARIANT:POINTER (../glib-2.62.6/tests/gobject/testmarshal.list:4) */
void
